...
<html>
    ...
    <body>
        ...
        <div class="menu">
            <div><br/><gc class="pos_pager"><i class="fa fa-home"></i> <a style="text-decoration: none;" href="<?php echo $settings_php_page; ?>"><gc style="font-weight: bold;">Accueil</gc></a></gc></div>
