...
<html>
    ...
    <body>
        <div class="sidenav">
            ...
            <a class="active" href="../gest_serv/"><i class="fa fa-terminal"></i> Console</a>
            <a href="../gest_serv/"><i class="fa fa-rocket"></i> Acces SFTP</a>
            <a href="../gest_serv/"><i class="fa fa-file-archive-o"></i> Backup</a>
            <a href="../gest_serv/"><i class="fa fa-database"></i> Base de données</a>
            <a href="../gest_serv/"><i class="fa fa-user-plus"></i> Sous-utilisateur</a>
            <a href="../gest_serv/"><i class="fa fa-folder-open"></i> Gestion des fichiers</a>
            <a href="../gest_serv/"><i class="fa fa-info"></i> Information</a>
            ...
            <div class="main">
                <center>
                    <div class="form-gest-server">
                        <a class="button-start" href="#"><i class="fa fa-play"></i> Démarrer le serveur</a>
                        <a class="button-restart" href="#"><i class="fa fa-refresh"></i> Redémarrer le serveur </a>
                        <a class="button-stop" href="#"><i class="fa fa-power-off"></i> Stopper le serveur</a>
                        <a class="button-stop" href="#"><i class="fa fa-eraser"></i> Tuer le serveur</a>
                    </div>
                </center>
            </div>
