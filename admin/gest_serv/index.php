...
fclose($fp);
                        ...
                        <td><a style="color: black;" href="../../gest_serv/?id=<?php echo $donnees2['id']; ?>"><?php echo $donnees2['id']; ?></a></td>
                        <td><a style="color: black;" href="../../gest_serv/?id=<?php echo $donnees2['id']; ?>"><?php echo $donnees2['proprio_id']; ?></a></td>
                        <td><a style="color: black;" href="../../gest_serv/?id=<?php echo $donnees2['id']; ?>"><?php echo $donnees2['server_location']; ?></a></td>
                        <td><a style="color: black;" href="../../gest_serv/?id=<?php echo $donnees2['id']; ?>"><?php echo $donnees2['adressip']; ?></a></td></tr>
                        <?php
                    }
                    ?>
