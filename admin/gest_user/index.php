...
<html>
    ...
    <body>
        <div class="sidenav">
            ...
            <a class="active" href="index.php"><i class="fa fa-users"></i> Mes comptes</a>
            <a href="settings.php"><i class="fa fa-gears"></i> Paramètres</a> 
